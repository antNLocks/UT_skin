...
public class MucaRenderer extends PApplet {
...
public void draw() {
  ...
  if ( rawBuffer != null ) {
    ...
    Mat resizedMat = resizeMat(imageToMat(skinImage), finalSize);
...
public Mat resizeMat(Mat img, Size destSize) {
  Mat skinImageResized = new Mat(destSize, img.type()); // new matrix to store resize image
  Imgproc.resize(img, skinImageResized, destSize, 0, 0, Imgproc.INTER_LANCZOS4); // resize // INTER_LANCZOS4
...
public void InterfaceSetup() {
 ...
 cp5.addButton("connect")
  ...
  accordion = cp5.addAccordion("acc")
    .setPosition((int) finalSize.width + x, 30)
    .setWidth(280)
    .addItem(g0)
    .addItem(g1)
    .addItem(g2)
...
public void controlEvent(ControlEvent theEvent) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MucaRenderer" };
    if (passedArgs != null) {
