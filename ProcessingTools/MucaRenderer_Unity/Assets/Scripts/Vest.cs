 ...
 * When it receives processed touchdown data, it uses Motors.cs to calculate the intensity of the motors 
 * and sends it to the BHaptics vest.
 */
public class Vest : MonoBehaviour, ISkinListener
{
    ...
    void Update()
    {
        if (counter++ > 20 && recomputeBufffer) // for test purposes
        {
