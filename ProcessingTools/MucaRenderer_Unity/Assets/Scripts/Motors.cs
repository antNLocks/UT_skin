...
/*
 * This script performs the intensity calculations of the motors to represent the touch according to the touch captured and processed.
 * To do this, simply specify the input data, call a calculation function and then look for the output data
 */
public class Motors
{
