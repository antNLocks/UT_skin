...
public class SkinProcessor extends ThreadProcess
{
	public static class ProcessingConfiguration implements Serializable{
		...
		public int MaxThreshold = 254;
		public int Noise_averageAlgo = 0;
		public int Noise_framesForAverage = 1;
		public float Noise_interpolationFactor = 0;
		public long SleepingTime = 100;

		public  int ResizeFactorCol = 10;
		public  int ResizeFactorRow = 10;

		public int RawBufferCol = 1;
		public int RawBufferRow = 1;
